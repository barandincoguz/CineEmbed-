...
```bash
cd "/Users/barandincoguz/Desktop/deep learning movie project/docs/report"
latexmk
```
...
```bash
cd "/Users/barandincoguz/Desktop/deep learning movie project/docs/report" && latexmk
```
...
```bash
cd "/Users/barandincoguz/Desktop/deep learning movie project/docs/report" && latexmk -gg
```
...
```bash
cd "/Users/barandincoguz/Desktop/deep learning movie project/docs/presentation"
...
```bash
open -a "Microsoft PowerPoint" "/Users/barandincoguz/Desktop/deep learning movie project/docs/presentation/intermediate-progress-presentation.pptx" 2>/dev/null \
  || open -a "Keynote"            "/Users/barandincoguz/Desktop/deep learning movie project/docs/presentation/intermediate-progress-presentation.pptx" 2>/dev/null \
...
echo "https://github.com/barandincoguz/CineEmbed-/tree/main/docs/report"
echo "https://github.com/barandincoguz/CineEmbed-/tree/main/docs/presentation"
```
